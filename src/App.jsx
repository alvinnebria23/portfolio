...
const projects = [
  ...
  {
    tag: "CRM System",
    title: "Java JSP CRM Application",
    desc: "Maintained and enhanced a Java JSP-based CRM web application, optimizing performance, scalability, and overall system reliability for long-running enterprise operations.",
    techs: ["Java", "JSP", "Seasar2"],
  },
  {
    tag: "Cloud / Backend",
    title: "AWS Serverless API Platform",
    desc: "Developed a Python backend API deployed on AWS, leveraging serverless services — SQS, Lambda, and CloudWatch — with CodePipeline for CI/CD to ensure automated, reliable deployments.",
    techs: ["Python", "AWS Lambda", "SQS", "CodePipeline"],
  },
  {
    tag: "Messaging",
    title: "SMS Messaging Web App",
    desc: "Designed and developed a Spring Boot-based SMS messaging platform, integrating third-party messaging APIs to enable reliable, automated message delivery at scale.",
